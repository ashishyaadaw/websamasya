...
function GetInTouch() {
  return (
    <div className="get-in-touch container-xxl">
    <div class="get-in-touch-container d-flex justify-content-center align-items-center">
      <svg
        class="get-in-touch-svg"
...
*/}
      <form
        ...
        action="submitGetInTouch.php"
        method="POST"
      >
        <h1 class="get-in-touch-title text-center mb-4 ft-andika">Request a Callback</h1>

        {/* <!-- Name --> */}
        <div class="get-in-touch-form-group position-relative">
          <label for="formName" class="d-block">
            <i class="bi bi-person-fill get-in-touch-icon "></i>
          </label>
          <input
            type="text"
            name="name"
            id="formName"
            class="get-in-touch-form-control get-in-touch-form-control-lg thick"
            placeholder="Name"
            required
          />
        </div>
        ...
        <div class="get-in-touch-form-group position-relative">
          <label for="formEmail" class="d-block">
            <i class="bi bi-envelope-at-fill get-in-touch-icon"></i>
          </label>
          <input
            type="email"
            id="formEmail"
        ...
        <div class="get-in-touch-form-group position-relative">
          <label for="formEmail" class="d-block">
            <i class="bi bi-telephone-fill get-in-touch-icon"></i>
          </label>
          <input
            type="phone"
            name="phone"
        ...
        <br />
        {/* <!-- Message --> */}
        <div class="get-in-touch-form-group get-in-touch-message">
          <textarea
            id="formMessage"
            type="text"
            name="message"
            class="get-in-touch-form-control get-in-touch-form-control-lg"
            rows="7"
            placeholder="Message"
          ></textarea>
        </div>
        ...
        <div class="text-center">
          <button
            type="submit"
            name="submit"
            class="websamasya-primary-btn get-in-touch-submit-btn"
            tabIndex="-1"
          >
            Send message
          </button>
