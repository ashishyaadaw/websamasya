...
import Svg from "./svg";
export default function SocialLink({ className }) {
  return (
    <>
      <ul className={className}>
        ...
        <li className="ms-3">
          ...
          <a
            ...
            href="https://twitter.com/ypa4india"
          >
            <Svg
              className="brand"
              width="24"
        ...
        <li className="ms-3">
          ...
          <a
            className="link-body-emphasis"
            href="https://instagram.com/ypa4india"
          >
            <Svg
              className="brand"
              width="24"
        ...
        <li className="ms-3">
          ...
          <a
            className="link-body-emphasis"
            href="https://in.linkedin.com/in/ypa4india"
          >
            <Svg
              className="brand"
              width="24"
        ...
        <li className="ms-3">
          ...
          <a
            className="link-body-emphasis"
            href="https://www.facebook.com/ypa4india"
          >
            <Svg
              className="brand"
              width="24"
        ...
        <li className="ms-3">
          ...
          <a
            className="link-body-emphasis"
            href="https://www.youtube.com/c/YPA4INDIA"
          >
            <svg
